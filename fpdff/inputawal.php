...
session_start();
require('koneksi.php');
$sql_pencipta = "SELECT * FROM pencipta";
$result_pencipta = $conn->query($sql_pencipta);

if ($result_pencipta === false) {
    echo "<script>alert('Gagal mengambil data pengusul: " . $conn->error . "');</script>";
}
    ...
    <form action="proses_inputawal.php" method="post">
            ...
            <div class="container">
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-8">
                            <select name="sub_jenis_ciptaan" id="sub_jenis_ciptaan"
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input type="text" name="judul" class="w-full mt-1 p-2 border rounded"
                    ...
                    <div>
                        <div class="row">
                            <div class="col-4">
                                <label class="block text-gray-700">Uraian Singkat Ciptaan <span
                                            class="text-red-500">*</span></label>
                            </div>
                            <div class="col-8">
                                <input type="text" name="uraian_singkat" class="w-full mt-1 p-2 border rounded"
                                       placeholder="Masukkan uraian singkat ciptaan">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="row">
                            <div class="col-4">
                                <label class="block text-gray-700">Tanggal Pertama Kali Diumumkan <span
                                            class="text-red-500">*</span></label>
                            </div>
                            <div class="col-8">
                                <input type="date" name="tanggal_pertama_kali_diumumkan"
                                       class="w-full mt-1 p-2 border rounded">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="text" name="negara_pertama_kali_diumumkan"
                                       class="w-full mt-1 p-2 border rounded" placeholder="Masukkan negara">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="row">
                        <div class="col-4">
                            <label class="block text-gray-700">Kota Pertama Kali Diumumkan <span
                                        class="text-red-500">*</span></label>
                        </div>
                        <div class="col-8">
                            <input type="text" name="kota_pertama_kali_diumumkan" class="w-full mt-1 p-2 border rounded"
                    ...
                    <div>
                        <div class="row">
                            <div class="col-4">
                                <label for="jenisHibah" class="block text-gray-700">Jenis Pendanaan<span
                                            class="text-red-500">*</span></label>
                            </div>
                            <div class="col-8">
                                <select id="jenisHibah" name="jenis_hibah" class="w-full mt-1 p-2 border rounded"
                                        onchange="showHibahOptions()">
                ...
                <div class="row">
                    <div class="col-4">
                        <label for="hibah" class="block text-gray-700 hidden" id="hibahLabel">Nama Pendanaan<span
                                    class="text-red-500">*</span></label>
                    </div>
                    <div class="col-8">
        ...
        <div class="bg-white p-6 rounded-b-lg shadow-md mb-6">
            <table class="table table-bordered mt-3">
                ...
                <tbody>
                <?php
                if ($result_pencipta !== null && $result_pencipta->num_rows > 0) {
                    $number = 0; // Inisialisasi variabel $number
        ...
        <div class="flex justify-between mt-4">
            <a href="daftar_user.php">
                <button type="button" id="tambahPenciptaBtnSebelumnya"
                        class="bg-green-800 text-white px-4 py-2 rounded">SEBELUMNYA
                </button>
            </a>
            <button type="submit" id="tambahPenciptaBtnSelanjutnya" class="bg-green-800 text-white px-4 py-2 rounded">
                SELANJUTNYA
            </button>
        </div>
    </form>
...
<?php
// Tutup koneksi setelah seluruh halaman selesai diproses/rendering.
$conn->close();
?>
</body>
<script>
