...
$status = isset($_GET['role']) ? htmlspecialchars($_GET['role']) : '';
?>
    ...
    <div class="bg-white p-6 rounded-b-lg shadow-md mb-6">
      <div class="container">
        <form action="proses.php" method="POST">
          <!-- Kirim dataid juga ke proses.php -->
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-8">
                <input class="w-full mt-1 p-2 border rounded" type="text" name="nama" required />
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-8">
                <input class="w-full mt-1 p-2 border rounded" type="text" name="alamat" required />
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-8">
                <input class="w-full mt-1 p-2 border rounded" type="text" name="kode_pos" required />
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-8">
                <input class="w-full mt-1 p-2 border rounded" type="text" name="nomer_telepon" required />
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-8">
                <select class="w-full mt-1 p-2 border rounded" name="role" required>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-8">
                <input class="w-full mt-1 p-2 border rounded" type="email" name="email" required />
              </div>
            </div>
          </div>

          <button class="bg-green-800 text-white px-4 py-2 rounded w-full mt-4" type="submit">SUBMIT</button>
        </form>
      </div>
    </div>
  </div>
